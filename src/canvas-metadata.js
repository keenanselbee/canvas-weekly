...
export const METADATA_NOTICE = 'Canvas refresh checks assignments, stored deadlines and submission status. Course messages, syllabus text and rubric criteria are checked when available. Assignment instructions and other materials remain incomplete; review coverage and last-known information.';
