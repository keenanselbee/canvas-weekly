...
import { renderMarkdown } from './guide.js';
...
<main><aside class="reading-note">Saved guide. Check off tasks in Canvas Weekly. Use your browser's Print command to print or save as PDF.</aside>
