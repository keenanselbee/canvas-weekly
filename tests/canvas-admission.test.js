...
test('enabled metadata queries match the reviewed admission selection', () => {
  ...
  for (const request of [metadataRequest('assignments', '1', '99'), enrollmentScopeRequest('1', '99'), ownSubmissionRequest('10', '99'), courseConversationsRequest('1', '99'), conversationTextRequest('10'), courseSyllabusRequest('1')]) {
