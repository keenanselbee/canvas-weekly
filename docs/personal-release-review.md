...
| System light/dark with persistent overrides | nativeTheme integration; desktop/package tests and light/dark screenshots; fresh packaged System profile detects the current Windows dark preference; four-page layout checks at rendering scales 1/1.25/1.5/2 and zoom 1/2 pass | Installer dark mode remains unimplemented; actual monitor/DPI transitions remain untested |
