...
if (process.argv.slice(2).some(value => value !== '--dir')) throw new Error('Only --dir is supported; publishing is disabled.');
...
const child = spawn(process.execPath, [path.join(root, 'node_modules/electron-builder/out/cli/cli.js'),
  '--config', 'electron-builder.json', '--win', '--x64', '--publish', 'never', ...(process.argv.includes('--dir') ? ['--dir'] : [])],
